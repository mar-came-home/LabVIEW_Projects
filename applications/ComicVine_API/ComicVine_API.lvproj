	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Libraries" Type="Folder">
			<Item Name="CV_Shared_Library.lvlib" Type="Library" URL="CV_Shared_Library/CV_Shared_Library.lvlib">
				...
				<Item Name="open.local.publisher.file.vi" Type="VI" URL="CV_Shared_Library/open.local.publisher.file.vi"/>
			...
			<Item Name="CV_RESTful_Lib.lvlib" Type="Library" URL="CV_RESTful_Library/CV_RESTful_Lib.lvlib">
				...
				<Item Name="GET_all_publishers.vi" Type="VI" URL="CV_RESTful_Library/GET_all_publishers.vi"/>
		...
		<Item Name="Editor_UI" Type="Folder">
			<Item Name="subvis" Type="Folder">
				...
				<Item Name="update_issue_display_date.vi" Type="VI" URL="Manager_UI/subvis/update_issue_display_date.vi"/>
				<Item Name="fix_issue_dates.vi" Type="VI" URL="Manager_UI/subvis/fix_issue_dates.vi"/>
			</Item>
		...
		<Item Name="Graphic UI" Type="Folder">
			<Item Name="definitions" Type="Folder">
				...
				<Item Name="filters--cluster.ctl" Type="VI" URL="Graphic_UI/typedefs/filters--cluster.ctl"/>
			</Item>
			<Item Name="subvi&apos;s" Type="Folder">
				...
				<Item Name="advanced.filter.dialog.vi" Type="VI" URL="Graphic_UI/subvis/advanced.filter.dialog.vi"/>
			</Item>
		...
		<Item Name="Utilities" Type="Folder">
			...
			<Item Name="CLZ_to_ComicVine.lvlib" Type="Library" URL="CLZ_to_ComicVine/CLZ_to_ComicVine.lvlib">
				<Item Name="subvis" Type="Folder">
					<Item Name="check_variant.vi" Type="VI" URL="CLZ_to_ComicVine/subvis/check_variant.vi"/>
					<Item Name="Generate_in-collection_map.vi" Type="VI" URL="CLZ_to_ComicVine/subvis/Generate_in-collection_map.vi"/>
					<Item Name="get_matched_issues.vi" Type="VI" URL="CLZ_to_ComicVine/subvis/get_matched_issues.vi"/>
					<Item Name="parse_clz_series.vi" Type="VI" URL="CLZ_to_ComicVine/subvis/parse_clz_series.vi"/>
					<Item Name="read_volume_set.vi" Type="VI" URL="CLZ_to_ComicVine/subvis/read_volume_set.vi"/>
					<Item Name="sync_issues.vi" Type="VI" URL="CLZ_to_ComicVine/subvis/sync_issues.vi"/>
				</Item>
				<Item Name="typedefs" Type="Folder">
					<Item Name="CLZ_comic--cluster.ctl" Type="VI" URL="CLZ_to_ComicVine/typedefs/CLZ_comic--cluster.ctl"/>
					<Item Name="clz_matching_issue--cluster.ctl" Type="VI" URL="CLZ_to_ComicVine/typedefs/clz_matching_issue--cluster.ctl"/>
					<Item Name="CLZ_series--cluster.ctl" Type="VI" URL="CLZ_to_ComicVine/typedefs/CLZ_series--cluster.ctl"/>
					<Item Name="issue_match--cluster.ctl" Type="VI" URL="CLZ_to_ComicVine/typedefs/issue_match--cluster.ctl"/>
					<Item Name="paths--cluster.ctl" Type="VI" URL="CLZ_to_ComicVine/typedefs/paths--cluster.ctl"/>
				</Item>
				<Item Name="CLZ Comics.lvclass" Type="LVClass" URL="CLZ_to_ComicVine/CLZ Comics/CLZ Comics.lvclass">
					<Item Name="CLZ Comics.ctl" Type="Class Private Data" URL="CLZ_to_ComicVine/CLZ Comics/CLZ Comics.lvclass/CLZ Comics.ctl"/>
					<Item Name="private" Type="Folder">
						<Item Name="load_full_report.vi" Type="VI" URL="CLZ_to_ComicVine/CLZ Comics/load_full_report.vi"/>
					</Item>
					<Item Name="typedefs" Type="Folder">
						<Item Name="issue_number--cluster.ctl" Type="VI" URL="CLZ_to_ComicVine/CLZ Comics/typedefs/issue_number--cluster.ctl"/>
						<Item Name="volume--cluster.ctl" Type="VI" URL="CLZ_to_ComicVine/CLZ Comics/typedefs/volume--cluster.ctl"/>
					</Item>
					<Item Name="get_issues_listbox_items.vi" Type="VI" URL="CLZ_to_ComicVine/CLZ Comics/get_issues_listbox_items.vi"/>
					<Item Name="get_volumes_listbox_items.vi" Type="VI" URL="CLZ_to_ComicVine/CLZ Comics/get_volumes_listbox_items.vi"/>
					<Item Name="load_clz_data.vi" Type="VI" URL="CLZ_to_ComicVine/CLZ Comics/load_clz_data.vi"/>
					<Item Name="map.get.vi" Type="VI" URL="CLZ_to_ComicVine/CLZ Comics/map.get.vi"/>
					<Item Name="search_cv.vi" Type="VI" URL="CLZ_to_ComicVine/CLZ Comics/search_cv.vi"/>
					<Item Name="set_id_mapped.vi" Type="VI" URL="CLZ_to_ComicVine/CLZ Comics/set_id_mapped.vi"/>
					<Item Name="update_progress_bar.vi" Type="VI" URL="CLZ_to_ComicVine/CLZ Comics/update_progress_bar.vi"/>
				</Item>
				<Item Name="CV Comics.lvclass" Type="LVClass" URL="CLZ_to_ComicVine/Volumes/CV Comics.lvclass">
					<Item Name="CV Comics.ctl" Type="Class Private Data" URL="CLZ_to_ComicVine/Volumes/CV Comics.lvclass/CV Comics.ctl"/>
					<Item Name="private" Type="Folder">
						<Item Name="load_full_report.vi" Type="VI" URL="CLZ_to_ComicVine/Volumes/load_full_report.vi"/>
					</Item>
					<Item Name="typedefs" Type="Folder">
						<Item Name="volume--cluster.ctl" Type="VI" URL="CLZ_to_ComicVine/Volumes/typedefs/volume--cluster.ctl"/>
					</Item>
					<Item Name="get_listbox_items.vi" Type="VI" URL="CLZ_to_ComicVine/Volumes/get_listbox_items.vi"/>
					<Item Name="get_volume_issues.vi" Type="VI" URL="CLZ_to_ComicVine/Volumes/get_volume_issues.vi"/>
					<Item Name="load_cv_data.vi" Type="VI" URL="CLZ_to_ComicVine/Volumes/load_cv_data.vi"/>
					<Item Name="search_cv.vi" Type="VI" URL="CLZ_to_ComicVine/Volumes/search_cv.vi"/>
					<Item Name="set_id_mapped.vi" Type="VI" URL="CLZ_to_ComicVine/Volumes/set_id_mapped.vi"/>
				</Item>
				<Item Name="Volume Matcher.vi" Type="VI" URL="CLZ_to_ComicVine/Volume Matcher.vi"/>
			</Item>
			<Item Name="Publisher Explorer.vi" Type="VI" URL="Utilities/Publisher Explorer.vi"/>
			<Item Name="DateChecker.vi" Type="VI" URL="Utilities/DateChecker.vi"/>
			<Item Name="PlotReleaseByYear.vi" Type="VI" URL="Utilities/PlotReleaseByYear.vi"/>
			<Item Name="apply.all.display_dates.with.cover_date.vi" Type="VI" URL="Utilities/apply.all.display_dates.with.cover_date.vi"/>
		</Item>
		<Item Name="Download Manager" Type="Folder">
			<Item Name="Download_Manager.lvlib" Type="Library" URL="Download_Manager/Download_Manager.lvlib">
				<Item Name="subvis" Type="Folder">
					...
					<Item Name="get_next_job.vi" Type="VI" URL="Download_Manager/subvis/get_next_job.vi"/>
		...
		<Item Name="manager_daemon.lvclass" Type="LVClass" URL="comic_manager/manager_daemon/manager_daemon.lvclass">
			...
			<Item Name="Accessors" Type="Folder">
				<Item Name="DL_events.get.vi" Type="VI" URL="comic_manager/manager_daemon/accessors/DL_events.get.vi"/>
				<Item Name="error_event.get.vi" Type="VI" URL="comic_manager/manager_daemon/accessors/error_event.get.vi"/>
				<Item Name="events.get.vi" Type="VI" URL="comic_manager/manager_daemon/accessors/events.get.vi"/>
				<Item Name="GraphicUI.events.get.vi" Type="VI" URL="comic_manager/manager_daemon/accessors/GraphicUI.events.get.vi"/>
			...
			<Item Name="Private" Type="Folder">
				...
				<Item Name="error_handler.vi" Type="VI" URL="comic_manager/manager_daemon/private/error_handler.vi"/>
				<Item Name="filter.release.week.vi" Type="VI" URL="comic_manager/manager_daemon/private/filter.release.week.vi"/>
			...
			<Item Name="SubVI&apos;s" Type="Folder">
				...
				<Item Name="get_publishers.vi" Type="VI" URL="comic_manager/manager_daemon/get_publishers.vi"/>
			</Item>
			<Item Name="TypeDefs" Type="Folder">
				...
				<Item Name="PublisherData--cluster.ctl" Type="VI" URL="comic_manager/manager_daemon/type_defs/PublisherData--cluster.ctl"/>
				<Item Name="PublisherMap--map.ctl" Type="VI" URL="comic_manager/manager_daemon/type_defs/PublisherMap--map.ctl"/>
			...
			<Item Name="add.publisher.vi" Type="VI" URL="comic_manager/manager_daemon/private/add.publisher.vi"/>
			<Item Name="close.vi" Type="VI" URL="comic_manager/manager_daemon/close.vi"/>
			...
			<Item Name="download_issues.vi" Type="VI" URL="comic_manager/manager_daemon/download_issues.vi"/>
			<Item Name="filter data.vi" Type="VI" URL="comic_manager/manager_daemon/filter data.vi"/>
			<Item Name="filter release date.vi" Type="VI" URL="comic_manager/manager_daemon/filter release date.vi"/>
			<Item Name="generate binary indices.vi" Type="VI" URL="comic_manager/manager_daemon/generate binary indices.vi"/>
			<Item Name="get publishers.vi" Type="VI" URL="comic_manager/manager_daemon/get publishers.vi"/>
			...
			<Item Name="update publisher.vi" Type="VI" URL="comic_manager/manager_daemon/update publisher.vi"/>
